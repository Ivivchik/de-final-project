CREATE TABLE IF NOT EXISTS IVIVCHIKYANDEXRU__DWH.s_transaction_amount(
    hk_transaction_amount_pk     INT           ,
    ...
    PRIMARY KEY (hk_transaction_amount_pk) ENABLED,
    CONSTRAINT h_transaction_pk_unique UNIQUE (h_transaction_pk) ENABLED
    
)
ORDER BY hk_transaction_amount_pk
SEGMENTED BY HASH(hk_transaction_amount_pk) ALL NODES
